...
switch flag,
  ...
  %%%%%%%%%%%%%%%
  case 1,
    sys=mdlDerivatives(t,x,u,mu,tau);
...
sizes.NumContStates  = 1; % DA SETTARE
sizes.NumDiscStates  = 0;
sizes.NumOutputs     = 1; % DA SETTARE
...
%=============================================================================
%
function sys=mdlDerivatives(t,x,u,mu,tau)
...
%=============================================================================
%
function sys=mdlOutputs(t,x,u,mu, tau)
